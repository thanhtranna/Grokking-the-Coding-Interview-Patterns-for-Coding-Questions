...
public:
    static int findLength(const string &str, int k)
    {
        ...
        unordered_map<char, int> letterFreequencyMap;
        ...
        for (int windowEnd = 0; windowEnd < str.length(); windowEnd++)
        {
            ...
            letterFreequencyMap[rightChar]++;
            maxRepeatLetterCount = max(maxRepeatLetterCount, letterFreequencyMap[rightChar]);
