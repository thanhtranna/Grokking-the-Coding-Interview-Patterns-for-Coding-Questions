        ...
        for (int windowEnd = 0; windowEnd < str.length(); windowEnd++)
        {
            ...
            while (matched == pattern.length())
            {
                ...
                if (charFrequencyMap.find(leftChar) != charFrequencyMap.end())
                {
                    ...
                    // matched count only when a useful accurrence of a matched character is going out of the window
...
{
    cout << MinimunWindowSubstring::findSubstring("aabdec", "abc") << endl;
    cout << MinimunWindowSubstring::findSubstring("abdabca", "abc") << endl;
    cout << MinimunWindowSubstring::findSubstring("adcad", "abc") << endl;
}
